import{n as e,o as t}from"./rolldown-runtime-CsOFd3vK.js";import{t as n}from"./react-Z7gd5LxR.js";import{o as r}from"./iframe-CsDFJ_4C.js";var i,a,o,s,c,l,u,d;function f(){return(f=e((()=>{i=t(n(),1),{fn:a}=__STORYBOOK_MODULE_TEST__,o=a().mockName(`next/link::Link`),s=e=>e.endsWith(`/`)&&e.length>1?e.slice(0,-1):e,c=e=>{let t=e.indexOf(`#`),n=e.indexOf(`?`),r=n>-1&&(t<0||n<t);return r||t>-1?{pathname:e.substring(0,r?n:t),query:r?e.substring(n,t>-1?t:void 0):``,hash:t>-1?e.slice(t):``}:{pathname:e,query:``,hash:``}},l=e=>{if(!e.startsWith(`/`))return e;let{pathname:t,query:n,hash:r}=c(e);return/\.[^/]+\/?$/.test(t)?`${s(t)}${n}${r}`:`${t.endsWith(`/`)?t:`${t}/`}${n}${r}`},u=i.forwardRef(function({href:e,as:t,replace:n,scroll:r,shallow:a,prefetch:s,passHref:c,legacyBehavior:u,locale:d,onClick:f,children:p,...m},h){let g=typeof e==`object`?`${e.pathname||``}${e.query?`?${new URLSearchParams(e.query).toString()}`:``}${e.hash||``}`:e,_=typeof g==`string`?l(g):g,v=e=>{e.preventDefault(),f?.(e),o(_,{replace:n,scroll:r,shallow:a,prefetch:s,locale:d})};if(u){let e=i.Children.only(p),t={ref:h,onClick:t=>{t.preventDefault(),e.props&&typeof e.props.onClick==`function`&&e.props.onClick(t),o(_,{replace:n,scroll:r,shallow:a,prefetch:s,locale:d})},...m};return(c||e.type===`a`&&!(`href`in(e.props||{})))&&(t.href=_),i.cloneElement(e,t)}return i.createElement(`a`,{ref:h,href:_,onClick:v,...m},p)}),u.displayName=`NextLink`,d=u,a(()=>({pending:!1})).mockName(`next/link::useLinkStatus`)})))()}var p;function m(){return(m=e((()=>{p={live:`公開中`,building:`制作中`,archived:`更新停止`,private:`非公開`}})))()}var h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{h=`_card_l51e7_1`,g=`_head_l51e7_12`,_=`_name_l51e7_20`,v=`_status_l51e7_26`,y=`_statusLive_l51e7_39`,b=`_statusBuilding_l51e7_44`,x=`_summary_l51e7_49`,S=`_stack_l51e7_54`,C=`_chip_l51e7_63`,w=`_actions_l51e7_72`,T=`_detail_l51e7_80`,E=`_external_l51e7_81`,D={card:h,head:g,name:_,status:v,statusLive:y,statusBuilding:b,summary:x,stack:S,chip:C,actions:w,detail:T,external:E}})))()}function k({work:e,headingLevel:t=3}){let n=t===2?`h2`:`h3`;return(0,A.jsxs)(`article`,{className:D.card,children:[(0,A.jsxs)(`div`,{className:D.head,children:[(0,A.jsx)(n,{className:D.name,children:e.name}),(0,A.jsx)(`span`,{className:`${D.status} ${j[e.status]}`,children:p[e.status]})]}),(0,A.jsx)(`p`,{className:D.summary,children:e.summary}),(0,A.jsx)(`ul`,{className:D.stack,children:e.stack.map(e=>(0,A.jsx)(`li`,{className:D.chip,children:e},e))}),(0,A.jsxs)(`div`,{className:D.actions,children:[(0,A.jsx)(d,{className:D.detail,href:`/work/${e.slug}`,"aria-label":`${e.name} をくわしく見る`,children:`くわしく`}),e.siteUrl===void 0?null:(0,A.jsx)(`a`,{className:D.external,href:e.siteUrl,target:`_blank`,rel:`noreferrer`,"aria-label":`${e.name} のサイトを開く（新しいタブ）`,children:`サイトを開く`}),e.repoUrl===void 0?null:(0,A.jsx)(`a`,{className:D.external,href:e.repoUrl,target:`_blank`,rel:`noreferrer`,"aria-label":`${e.name} のリポジトリ（新しいタブ）`,children:`リポジトリ`})]})]})}var A,j;function M(){return(M=e((()=>{A=r(),f(),m(),O(),j={live:D.statusLive??``,building:D.statusBuilding??``,archived:``,private:``},k.__docgenInfo={description:`作品 1 つのカード。
