...
export type SocialLink = {
  ...
  /** ふつうは利用者名なのでそのまま。LINE だけは文言なので訳す */
...
export const socialLinks: readonly SocialLink[] = [
  {
    id: 'github',
    label: 'GitHub',
    handle: { ja: 'RimlTempest', en: 'RimlTempest' },
  ...
  },
  {
    id: 'facebook',
    label: 'Facebook',
    handle: { ja: 'R1mlTempest', en: 'R1mlTempest' },
